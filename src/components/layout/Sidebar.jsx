...
const mainNav = [
  ...
  { to: "/potential", label: "Potential Work", icon: Radar },
  { to: "/manpower", label: "Manpower", icon: ClipboardList },
  { to: "/silabus", label: "Silabus", icon: BookOpen },
...
export default function Sidebar({ open = false, onClose = () => {} }) {
  ...
  return (
    ...
    >
      ...
      {/* Main nav — scroll kalau kepanjangan */}
      <nav className="scroll-slim mt-8 flex min-h-0 flex-1 flex-col gap-1 overflow-y-auto pb-2">
      ...
      {/* User + sign out */}
      <div className="flex shrink-0 flex-col gap-2 border-t border-zinc-200/70 pt-4">
        <div className="px-3">
